                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('login.proses')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo e(old('user_name')); ?>" placeholder="Masukkan username" autofocus>
                            </div>
                            <div class="mb-4">
...
</html><?php /**PATH D:\XAMP\htdocs\aplikasi-blog\resources\views/login/index.blade.php ENDPATH**/ ?>